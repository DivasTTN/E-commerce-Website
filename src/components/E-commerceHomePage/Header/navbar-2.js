...
import CartButton from "../../E-commerceCart/HeaderCartButton/cartButton";

const NavbarPart = () => {
  return (
    <nav class="top navbar bg-success navbar-expand-lg navbar-expand-md navbar-expand-sm navbar-dark " >
